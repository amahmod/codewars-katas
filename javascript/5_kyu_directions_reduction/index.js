/*
  ...
  Discuss Link: https://www.codewars.com/kata/550f22f4d758534c1100025a/discuss

  Solutions Link: https://www.codewars.com/kata/550f22f4d758534c1100025a/solutions
...
Write a function `dirReduc` which will take an array of strings and returns an array of strings with the needless directions removed (WE or SN *side by side*).
...
function dirReduc(arr) {
  const reduced = arr
    .join(',')
    .replace(/(north,south|south,north),?|(east,west|west,east),?/gi, '')
    .split(',')

  if (reduced.length === arr.length) return reduced.filter(d => d.length > 1)
